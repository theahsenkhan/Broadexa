...
export function SignupForm({ oauth }: { oauth: { google: boolean; linkedin: boolean } }) {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    try {
      const createRes = await fetch('/api/users', {
        ...
        body: JSON.stringify({ name, username: slugify(username), email, password, role }),
      })
  ...
  return (
    <div className="form-shell">
      ...
      <OAuthButtons oauth={oauth} next={next} role={role} />
      ...
      <form onSubmit={onSubmit}>
        ...
        <div className="field">
          ...
          <input
            ...
            title="Lowercase letters, numbers, dots, dashes or underscores"
          />
          <span className="field-hint">Your profile URL — broadexa.com/designer/{username || 'yourname'}</span>
        </div>
        <div className="field">
          <label>Email</label>
